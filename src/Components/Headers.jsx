...
function Headers({ MenuSectionFunc, MEnuSectionDisplay, theme }) {
    ...
    <div className="header" style={{ backgroundColor: theme }}>
      <div className="header_left">
        ...
        <Link to={"/"}>
          {/* <img
            ...
            alt=""
          /> */}
          <YouTubeIcon style= {{color : "red" , transform : "scale(3.5)"}}className="header_logo"/>
        </Link>
      </div>
      <div className="header_input">
       ...
       <Link to={`/search/${inputSearch}`}>
          <YoutubeSearchedForIcon className="header_inputButton" style= {{color : theme === "black" ? "white" : "black"}} />
        </Link>
       </span>
      </div>
      ...
      <div className="header_icons">
        <VideoCallIcon
          className="header_icon videoIcon"
          style={{ color: theme === "black" ? "white" : "black" }}
        />
        <AppsIcon
          className="header_icon appIcon"
          style={{ color: theme === "black" ? "white" : "black" }}
        />
        <NotificationIcon
          className="header_icon notificationIcon"
          style={{ color: theme === "black" ? "white" : "black" }}
        />
        <Avatar
